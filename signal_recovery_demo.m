% Demo for examining the signal recovery performance
%---------------------------------------------------
maindir = [cd, '\Results\Signal_Recovery\', date, '\'];
addpath(genpath(cd))
...
params_struct.Normalization = 'trace';
X_recover_different_experiments( params_struct, experiments, maindir);
