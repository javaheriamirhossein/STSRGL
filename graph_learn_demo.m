% Demo for examining the graph learning performance
%---------------------------------------------------
maindir = [cd, '\Results\Graph_Learning\', date, '\'];
addpath(genpath(cd))
...
graph_learn_different_experiments( params_struct, experiments, maindir);
