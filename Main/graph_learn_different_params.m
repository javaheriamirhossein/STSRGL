function [Results, title_cell] = graph_learn_different_params(  params_struct, params_type, params_vec )
% Running graph learning experiments at different scenarios
...
%% Running the graph learning algorithms for Ntrials
...
%     end
    ...
    for trial = 1:Ntrials
        ...
        [Result, title_cell] = graph_learning_algorithms( Y, data_struct, params_struct);
        ...
        AUC_all{n, trial} = Result.AUC;
        NumEdge_cell_all{n, trial} = Result.NumEdge;
    end
...
Results.AUC = AUC_all;
Results.NumEdge = NumEdge_cell_all;
